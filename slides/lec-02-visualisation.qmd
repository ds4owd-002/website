...
You successfully complete the course and youwill receive a certificate of completion if you:
...
## Tipps for search engines (e.g. [duckduckgo.com](https://duckduckgo.com/))
...
## Tipps for AI tools (e.g. [duck.ai](https://duck.ai))
...
- [md-0X-exercises]{.highligh-yellow} (this is for lectures and we only work with it during lectures)
- [md-0X-assignments-USERNAME]{.highligh-yellow} (this is your homework and every module will have your username at the end of it. You will clone this to Posit Cloud to work with it)
...
- Click [Start]{.highligh-yellow} the first time
- Click [Continue]{.highligh-yellow} the next time
