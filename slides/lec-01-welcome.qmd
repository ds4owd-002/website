...
## Meet the team (TODO: Add a third person Nicoló Massari with each person taking up 33% of the slide, make images smaller and align left)
...
## Learning Goals (for the course) (TODO: underline learning goals instead of bold)
...
-   Function: `filter()`
-   Argument: `.data =` **Does not need to be be spelled out**
...
-   Argument: `.data =`
-   Arguments following: `year == 2007` 
-   Assignment operator: `<-` **Assigns the result to an object**
-   Object: `gapminder_yr_2007` **Name of the object that stores result**
...
-   Assignment operator: `<-`
-   Pipe operator: `|>` **Passes the result into the first argument of the next function**
...
## Repeated information many times (TODO: write a callout and a better title that I will repeat these fundamentals many times in the next weeks and participants are not expected to remember and/or fully understand this now)
