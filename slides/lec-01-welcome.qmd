...
![](img/lec-01/profile-nicolo.jpg){fig-alt="Headshot of Nicolò Massari" fig-align="left" width="150"}
...
3.  [Practice open science]{.underline} - Share your data and code openly, following best practices for reproducibility and collaboration.

4.  [Build a portfolio]{.underline} - Complete real-world projects that demonstrate your skills to future employers or collaborators.
...
-   During [my turn]{.highlight-yellow} and [our turn]{.highlight-yellow} segments: Please keep your microphone on mute. Send message to the [Zoom chat]{.highlight-yellow} Adriana and Nicoló will support you

-   During [your turn]{.highlight-yellow} segments: Due to the large number of participants, it will not be feasible to join individual break-out rooms, but you will always be working in groups of 2 to 4 people.
...
::: task
We will create a bookmarks folder for this course.
:::
...
7. Add a comment to the issue and tag [@seawaR]{.highlight-yellow}, [@massarin]{.highlight-yellow}, and Lars with [@larnsce]{.highlight-yellow}, and your [room partner]{.highlight-yellow} to ask for support during the homework assignments
...
-   Quiz due [one week after homework assignment]{.highlight-yellow}
