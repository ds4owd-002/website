...
|          |                                           |
|----------|-------------------------------------------|
| **Monday**   | Homework due (starting from Module 2) |
...
-   Homework due [Wednesdays before next module]{.highlight-yellow}
-   Quiz due [one week after homework]{.highlight-yellow}
