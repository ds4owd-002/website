...
[Due date:]{.highlight-yellow} Wednesday, {{< var md-01.homework-due >}}
...
-   [Assignment 3](../assignments/md-01/am-01-3-github-pat.qmd): Homework: GitHub Personal Access Token [in preparation]{.highlight-yellow}
-   [Assignment 4](../assignments/md-01/am-01-4-github-clone.qmd): Homework: Clone a GitHub repository [in preparation]{.highlight-yellow}
-   [Assignment 5](../assignments/md-01/am-01-5-github-workflow.qmd): Homework: GitHub workflow [in preparation]{.highlight-yellow}

Thank you for working through these assignments.

## {{< fa clipboard-question >}} Quiz

[Due date:]{.highlight-yellow} Wednesday, {{< var md-01.quiz-due >}}
