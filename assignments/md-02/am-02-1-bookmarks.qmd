...
![](images/bookmarks/screenshot-github-issue-with-image.png){width=100%}

8. Scroll down the page a bit and click the green [Submit new issue]{.highlight-yellow} button.
