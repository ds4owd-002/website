...
4. Enter a commit message in the "Commit message" field in the top right corner. For example: replaced placeholders with my details
...
TODO: warning call out: warn learner that if the have stored their PAT in a Word file, then a blank space might have been copied along with the PAT. Recommend to use a TXT file using Notepad or Mac TextEdit, or a password manager to store the PAT.
...
2. Navigate to the GitHub organisation for the course: {{< var course.github-org >}} TODO: turn this into hyperlink
...
7. In the "Title" field write: "Completed module 1 assignment".

![](images/github-workflow/step3/screenshot-github-issue-title.png){width=100%}

8. In the "Leave a comment" field, tag the course instructors `@seawaR` `@massarin` `@larnsce`  and write a short message, e.g., "I have completed the module 1 assignment. Please review my work." You can also add any questions you have or other comments you would like to share with the instructors.

![](images/github-workflow/step3/screenshot-github-issue-comment.png){width=100%}

9. Scroll down the page a bit and click the green **Create** button. 
