...
## {{< fa circle-question >}} {.center-align .smaller}
...
1. Complete the [quiz of each week by its due date]{.highlight-yellow}

2- Hand in a [complete capstone project report]{.highlight-yellow} that uses a dataset of your choice by [11 December 2025]{.highlight-yellow} (instructions will follow)

While [homework assignments]{.highlight-yellow} are not required for completion, we [highly recommend working on them]{.highlight-yellow} and submitting it for feedback. This is the practice you need to become a data scientist.
...
# Solving coding problems online {background-color="#4C326A"}

## Tips for search engines (e.g. [duckduckgo.com](https://duckduckgo.com/))
...
## Tips for AI tools (e.g. [duck.ai](https://duck.ai))
...
- Mastodon / Bluesky tag: [#rstats](https://fosstodon.org/tags/rstats)
:::
...
# Exercises & Assignments {background-color="#4C326A"}

## Note

For every week, there will be two “projects”:

- [md-0X-exercises]{.highlight-yellow} (this is for lectures and we only work with it during lectures)
- [md-0X-assignments-USERNAME]{.highlight-yellow} (this is your homework and every module will have your username at the end of it. You will clone this to Posit Cloud to work with it)
...
- Click [Start]{.highlight-yellow} the first time
- Click [Continue]{.highlight-yellow} the next time
...
![](img/lec-02/posit-cloud-exercise.png)
...
[Assignment 1 of Module 2 is a Bookmark Folder assignment!]{.highlight-yellow}
...
::: learn-more
[posit.cloud/spaces/663318/](https://posit.cloud/spaces/663318/)
...
2. In my courses, they play a very small part, but I am confident that you will be able to enhance your knowledge on modelling once you understand the basic principles of using the R language.
...
- Inspired by the book [Grammar of Graphics by Leland Wilkinson](https://en.wikipedia.org/wiki/Wilkinson%27s_Grammar_of_Graphics)
...
![](img/lec-04/pixel-art-tree.png){width="50%"}
...
4. In the File Manager in the bottom right window, locate the [`md-02b-visualize.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
...
::: task
1. [If you closed it]{.highlight-yellow}, open [posit.cloud/spaces/663318/content](https://posit.cloud/spaces/663318/content) in your browser.
2. Verify that the [ds4owd workspace]{.highlight-yellow} is open.
3. Click [Continue]{.highlight-yellow} next to [md-02-exercises]{.highlight-yellow}.
4. In the File Manager in the bottom right window, locate the [`md-02c-boxplot.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
...
```{=html}
<iframe src="https://www.data-to-viz.com/" width="100%" height="500" style="border:2px solid #123233;" title="From Data to Viz"></iframe>
```
:::
...
::: learn-more
[{{< var course.site-short >}}content/modules/md-02.html]({{< var course.site >}}content/modules/md-02.html)

```{=html}
<iframe src="{{< var course.site >}}content/modules/md-02.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 2 documentation"></iframe>
```
:::

## Homework due date

-   Homework assignment due: [Wednesday, {{< var md-02.homework-due >}}]{.highlight-yellow}
-   Quiz due: [Wednesday, {{< var md-02.quiz-due >}}]{.highlight-yellow} 
...
Access slides as [PDF on GitHub]({{< var course.github-org >}}/website/raw/main/content/slides/lec-02-visualisation.pdf)
