...
1. [hand in a complete capstone project report that uses a dataset of your choice by 11th December 2025]{.highlight-yellow}. Required items: [{{< var course.site >}}content/project/]({{< var course.site >}}content/project/)

2. Complete all quizzes from module 1 through to module 6. [no more quizzes will be hosted for module 7 and module 8]{.highlight-yellow}.

These are the only requirement to successfully complete the course, independent of how many classes you attended or how many homework assignments you completed.
...
2. They also used a proprietary citation style files that could only be opened by EndNote.
...
- Prepared a setup guide: [{{< var course.site >}}/guide/#zotero-reference-management]({{< var course.site >}}/guide/#zotero-reference-management)
...
1. Open [posit.cloud/spaces/663318/content](https://posit.cloud/spaces/663318/content) in your browser.
2. Verify that the [ds4owd workspace]{.highlight-yellow} is open.
3. Click [Continue]{.highlight-yellow} next to [md-08-exercises]{.highlight-yellow}.
...
1. Clone the [md-08-publish-USERNAME repository]({{< var course.github-org >}}) from the GitHub organisation to Posit Cloud.
2. From the Files Manager in the bottom right window, open [`docs`]{.highlight-yellow} folder, then click on [`index.qmd`]{.highlight-yellow}.
3. Indicate the open Poll with ["ready to go"]{.highlight-yellow} when you are ready.
...
- Steps for publishing the capstone project report are described in the [course guide]({{< var course.site >}}/guide/#publish-to-github-pages)
...
- The submission due date is: [Wednesday, 11th December 2025]{.highlight-yellow}.
- We will use the GitHub issue tracker to communicate and ask questions about the capstone project.
- A list of required items for submission is covered on the [course website]({{< var course.site >}}content/project/)
- If you require an extension, please reach to us via email: <ghe@mavt.ethz.ch>

## Your turn: Capstone project - Read and take notes

::: task
1. Open: [{{< var course.site >}}content/project/]({{< var course.site >}}content/project/)
...
1. Open this repository: [{{< var course.github-org >}}/project]({{< var course.github-org >}}/project)
...
- **Date:** Thursday, November 27, 2:00 - 4:30 PM (CET)

## Module 10: Graduation party

- **Date:** Wednesday, December 18, 2:00 - 3:00 PM (CET)

## Attribution

Content was re-used from a workshop hosted by [Mine Çetinkaya-Rundel](https://mine-cr.com/) at the 2025 Symposium on Data Science and Statistics and stored at <https://github.com/mine-cetinkaya-rundel/quarto-sdss>. The original content is licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).

## Thanks!

Slides created via revealjs and Quarto: <https://quarto.org/docs/presentations/revealjs/>

Access slides as [PDF on GitHub]({{< var course.github-org >}}/website/raw/main/content/slides/lec-08-quarto.pdf)