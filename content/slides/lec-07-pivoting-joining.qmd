...
4. In the File Manager in the bottom right window, locate the [`md-07a-pivoting-your-turn.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
