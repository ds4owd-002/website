...
waste_data_lord1 <- read_csv(
  here::here("content/slides/data/waste-characterisation-lord-of-the-bins-sheet1.csv"))

waste_data_lord2 <- read_csv(
  here::here("content/slides/data/waste-characterisation-lord-of-the-bins-sheet2.csv"))

survey_data <- read_csv(here::here("content/slides/data/survey-data-partners-in-grime.csv")) |> 
  mutate(id = seq(1:n()))
...
Slides created via revealjs and Quarto: https://quarto.org/docs/presentations/revealjs/ Access slides as [PDF on GitHub](https://github.com/cven5873-ss23/website/raw/ma../../slides/lec-04-tidy-data.pdf)
