...
3. Click [Start]{.highlight-yellow} next to [md-04-exercises]{.highlight-yellow}.
4. In the File Manager in the bottom right window, locate the [`02a-factors-your-turn.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
...
::: {.column width="50%"}
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img/lec-04/readxl.png")
```
:::
:::
...
1. Open [posit.cloud/spaces/663318/content](https://posit.cloud/spaces/663318/content) in your browser.
2. Verify that the [ds4owd workspace]{.highlight-yellow} is open.
3. Click [Continue]{.highlight-yellow} next to [md-04-exercises]{.highlight-yellow}.
4. In the File Manager in the bottom right window, locate the [`03a-import-your-turn.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
...
::: footer
Journal: The American Statistician, [Screenshot taken on 2025-10-02](https://www.tandfonline.com/action/showMostReadArticles?journalCode=utas20)
:::
...
## Assignment 1: Identify and assess data {.smaller}

::: {.callout-important}
## This is the most important assignment!

To support you efficiently through to the end of the course, [we need to identify your capstone project data now]{.highlight-yellow}.

This gives us time to discuss data suitability with each of you individually.
:::
...
1. Identify 1-2 potential datasets
2. Assess privacy and sensitivity
3. Document required modifications
4. Open GitHub issue to discuss with instructors
:::

::: {.column width="50%"}
**Remember:**

- All capstone projects will be [published openly]{.highlight-yellow}
- Personal identifiers must be removed
- When in doubt, exclude or aggregate
:::
:::

## Assignment 2: Study groups (Mentorship programme) {.smaller}

::: columns
::: {.column width="50%"}
We've identified some participants with more experience who can help support others in the course.

[Join a study group on GitHub Discussions!]{.highlight-yellow}

- Groups will have 5-6 members
- Meet with your group to discuss 
- Support each other through the modules
:::

::: {.column width="50%"}
::: task
1. Navigate to [GitHub Discussions](https://github.com/orgs/ds4owd-002/discussions/categories/group)
2. Find the [Group]{.highlight-yellow} category
3. [Join one of the discussions]{.highlight-yellow} to join a group
4. Be mindful to distribute evenly - aim for 5-6 members per group
:::

::: {.callout-important}
If your username appears in the assignment instructions, please join the study group with your username in the title - you've been identified as someone with experience who can help others!
:::
:::
:::
...
::: learn-more
[{{< var course.site-short >}}content/modules/md-04.html]({{< var course.site >}}content/modules/md-04.html)

```{=html}
<iframe src="{{< var course.site >}}content/modules/md-04.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 4 documentation"></iframe>
```
:::
...
-   Quiz due: [Wednesday, October 15th 2025]{.highlight-yellow}
...
Access slides as [PDF on GitHub]({{< var course.github-org >}}/website/raw/ma../../slides/lec-04-spreadsheets.pdf)
