...
::: learn-more
[{{< var course.site-short >}}content/modules/md-03.html]({{< var course.site >}}content/modules/md-03.html)

```{=html}
<iframe src="{{< var course.site >}}content/modules/md-03.html" width="100%" height="500" style="border:2px solid #123233;" title="Module 3 documentation"></iframe>
```
:::
