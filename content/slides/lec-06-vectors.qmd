...
4. In the File Manager in the bottom right window, locate the [`01a-cref-your-turn.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
...
2. Verify that the [ds4owd workspace]{.highlight-yellow} is open.
3. Click [Start]{.highlight-yellow} next to [md-06-exercises]{.highlight-yellow}.
4. In the File Manager in the bottom right window, locate the [`03a-types-your-turn.qmd`]{.highlight-yellow} file and click on it to open it in the top left window.
:::
